...
#     import sys
    ...
    if algorithm == 'SMW-Fisher' or algorithm == 'SMW-Fisher-momentum' or algorithm == 'kfac' or\
    algorithm == 'SMW-Fisher-D_t-momentum':
#         import torch
...
#     print('old ll_chunk: ', oldll_chunk)
    ...
    if oldll_chunk - ll_chunk < 0:
        ...
        if algorithm == 'SMW-Fisher' or algorithm == 'SMW-GN' or algorithm == 'SMW-Fisher-D_t-momentum':
